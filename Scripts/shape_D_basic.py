...
def main():
    ...
    #hd = -0.25  # meters, don't get too close or range value gives vale of object, causing either z2pick to over or undershoot
    hd = -0.15  # meters, don't get too close or range value gives vale of object, causing either z2pick to over or undershoot
    z_theta_i = 0  #for total [-3.059 3.059]  this will be variable based on object type - later
