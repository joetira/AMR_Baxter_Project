...
def get_distance(irdist):
    rangeD = irdist.range
    #is there better way than using global to return function value, I cant get return working right in main
    global rangeD
    print rangeD
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/robot/range/right_hand_range/state', Range, get_distance)
