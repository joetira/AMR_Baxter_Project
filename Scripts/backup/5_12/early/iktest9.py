...
def CenterOnBall(pnp, idx, hd, initial_poses, z_theta):
    ...
    xCenter = (pnp.xbar >= 310 and pnp.xbar <= 330)  #original values 315 and 325
    yCenter = (pnp.ybar >= 190 and pnp.ybar <= 210) #original values 195 and 205
...
def main():
    ...
    initial_poses.append(Pose(
        position=Point(x=0.60, y=-0.35, z=00.129),
    ...
    while baxter_bet == willbeinputlater:
        baxter_bet = random.randint(1, 6)
    print "++++++++++++++++++++++"
    print "Mr. Baxter bets on ", baxter_bet
    print "User bets on ", willbeinputlater
    print "++++++++++++++++++++++"
    ...
    while not rospy.is_shutdown():
        ...
        if center_cond[0]==True and center_cond[1]==True:
            ...
            if pnp.die is not None:
                print(pnp.die.value)
                if pnp.die.value == willbeinputlater or pnp.die.value == baxter_bet:
                    print "++++++++++++++++++++++"
                    print "Dice roll of", pnp.die.value, " successfully found"
                    if pnp.die.value == willbeinputlater:
                        print "user wins"
                        print "++++++++++++++++++++++"
