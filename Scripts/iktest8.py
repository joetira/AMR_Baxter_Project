...
from PickAndPlaceTest import PickAndPlace
    ...
    while not rospy.is_shutdown():
        ...
        if (center_cond[0]==False and center_cond[1]==False):
            ...
            #while rangeD > 0.18:
                #hd -= 0.01
                #pnp._approach(initial_poses[idx], hd)
            # CenterOnBall(pnp, idx, hd, initial_poses, z_theta) # this statement doesn't do anything, since it is called again above after looping again.
            if args["verbose"]:
                print("centering")
